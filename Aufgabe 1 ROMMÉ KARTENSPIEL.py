...
###Teil1
hand1,hand2,hand3,zugstapel,ablagestapel = karten_austeilen()

##teil2
print('Hand 1:')
print(hand1)
auswahl = int(input("Weleche karte ablegen (1-14)?"))
abgelegt_karte = karte_ablegen(hand1,auswahl)
...
print('Hand 2:')
print(hand2)
quelle_auswahl = input(" Karte vom ablege- oder Zugstapel nehmen (A/Z)?")
if quelle_auswahl == 'Z':
    quelle = zugstapel
elif quelle_auswahl == 'A':
    quelle = ablagestapel

hand2 = karte_ziehen(hand2,quelle)
print('Hand 2:')
print(hand2)
auswahl = int(input("Weleche karte ablegen (1-14)?"))
abgelegt_karte = karte_ablegen(hand2,auswahl)
ablagestapel.append(abgelegt_karte)
print('ablagestapel :')
print(ablagestapel)
print('Hand 2:')
...
print(zugstapel)
#### Teil 4
print('oben auf dem Ablagestapel :')
print(ablagestapel[-1])
print('Hand 3:')
print(hand3)
quelle_auswahl = input(" Karte vom ablege- oder Zugstapel nehmen (A/Z)?")
if quelle_auswahl == 'Z':
    quelle = zugstapel
    hand3 = karte_ziehen(hand3, quelle)
    print('zugstapel')
    print(zugstapel)
elif quelle_auswahl == 'A':
    quelle = ablagestapel
